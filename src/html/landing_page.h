...
String getLandingPage(bool enableLED, bool enableLogging, bool enableAlerts,
    ...
    html += "<input type='checkbox' id='enableLED' name='enableLED' onchange='this.value = this.checked ? 1 : 0' value='" + String(enableLED ? 1 : 0) + "' " + String(enableLED ? "checked" : "") + ">";
    ...
    html += "<td style='padding: 8px; text-align: right;'>";
    html += "<label class='switch'>";
    html += "<input type='checkbox' id='enableLogging' name='enableLogging' onchange='this.value = this.checked ? 1 : 0' value='" + String(enableLogging ? 1 : 0) + "' " + String(enableLogging ? "checked" : "") + ">";
    html += "<span class='slider'></span>";
    html += "</label>";
    html += "</td>";
    html += "</tr>";
    ...
    html += "<td style='padding: 8px; text-align: right;'>";
    html += "<label class='switch'>";
    html += "<input type='checkbox' id='enableAlerts' name='enableAlerts' onchange='this.value = this.checked ? 1 : 0' value='" + String(enableAlerts ? 1 : 0) + "' " + String(enableAlerts ? "checked" : "") + ">";
    html += "<span class='slider'></span>";
    html += "</label>";
    html += "</td>";
    html += "</tr>";
    ...
    html += "<td style='padding: 8px; text-align: right;'>";
    html += "<input type='range' id='brightness' name='brightness' min='1' max='255' value='" + String(strip_brightness) + "' oninput='this.nextElementSibling.value = this.value'>";
